...
import type { WikiSpaceMemberOutput, WikiSpaceRole } from '@worknest/shared';
import { Avatar, Button, Input, Separator, Skeleton } from '@worknest/ui';
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuItem,
...
export function SpaceMembers({ spaceId }: SpaceMembersProps) {
  ...
  const membersQuery = useQuery({
    ...
    queryFn: () => apiClient.getList<MemberWithUser>(`/wiki-spaces/${spaceId}/members`),
  });
  ...
  return (
    <div className="space-y-4">
      ...
      <div>
        ...
        <p className="text-sm text-muted-foreground">스페이스 멤버를 관리합니다.</p>
      </div>
