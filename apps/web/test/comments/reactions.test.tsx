...
vi.mock("@worknest/ui", () => ({
  Popover: ({ children, open }: { children: React.ReactNode; open?: boolean; onOpenChange?: (v: boolean) => void }) =>
...
describe("Reactions", () => {
  ...
  it("renders reaction pills with emoji and count", () => {
    const reactions = [
      makeReaction({ id: "r1", emoji: "👍", userId: "u1", user: { id: "u1", name: "Alice", avatarUrl: null } }),
      makeReaction({ id: "r2", emoji: "👍", userId: "u2", user: { id: "u2", name: "Bob", avatarUrl: null } }),
      makeReaction({ id: "r3", emoji: "❤️", userId: "u1", user: { id: "u1", name: "Alice", avatarUrl: null } }),
    ];
  ...
  it("self-reacted reaction has bg-primary/10 styling", () => {
    const reactions = [
      makeReaction({ id: "r1", emoji: "🚀", userId: "me", user: { id: "me", name: "Me", avatarUrl: null } }),
    ];
  ...
  it("non-self-reacted reaction uses muted background", () => {
    const reactions = [
      makeReaction({ id: "r1", emoji: "👍", userId: "other", user: { id: "other", name: "Other", avatarUrl: null } }),
    ];
