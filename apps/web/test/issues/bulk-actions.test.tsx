...
vi.mock("@worknest/ui", () => ({
  ...
  DropdownMenuItem: ({
    ...
    React.createElement("button", { onClick: onClick ?? onSelect, "data-testid": "dropdown-item" }, children),
...
function renderBulkActionBar(overrides: {
  selectedIds?: string[];
